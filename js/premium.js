...
(function(){
  document.addEventListener('DOMContentLoaded',function(){
    ...
    // Copy email buttons
    function copyEmail(){
      navigator.clipboard.writeText('pranalithorve@gmail.com').then(()=>{
    ...
    const copyBtn2 = document.getElementById('copy-email-2');
    if(copyBtn2) {
      copyBtn2.addEventListener('click',()=>{
        copyEmail();
        copyBtn2.textContent='Copied ✓';
        setTimeout(()=>copyBtn2.textContent='Copy Email', 2000);
      });
    }

    const copyBtnCta = document.getElementById('copy-email-cta');
    if(copyBtnCta) {
      copyBtnCta.addEventListener('click',()=>{
        copyEmail();
        copyBtnCta.textContent='📧 Copied!';
        setTimeout(()=>copyBtnCta.textContent='📧 Get In Touch', 2000);
      });
    }
